...
import com.tuum.account.messaging.event.AccountCreated;
...
public class AccountExchangePublisher extends EventPublisher {
    ...
    public List<Class<? extends TuumEvent>> getTypesToPublish() {
        return List.of(AccountCreated.class);
    }

    @Override
    String getExchangeName() {
        return accountExchange.getName();
    }
